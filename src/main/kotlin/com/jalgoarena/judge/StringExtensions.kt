...
fun String.findJRubyClassName(): Optional<String> {

    val matcher = PATTERN_FOR_FINDING_JRUBY_CLASS_NAME.matcher(this)
    return if (matcher.find()) Optional.of(matcher.group(1)) else Optional.empty<String>()
}
...
private val PATTERN_FOR_FINDING_JRUBY_CLASS_NAME =
